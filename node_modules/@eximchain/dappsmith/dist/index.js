...
var DappSmith_1 = __importDefault(require("./DappSmith"));
var fs = require("fs");
...
program
    ...
    var dappsmith = new DappSmith_1.default({ abi: abi, name: contract_name, contract_addr: contract_addr, web3URL: web3URL });
    dappsmith.generate();
    if (options.build) {
        dappsmith.build();
    }
...
if (require.main === module) {
    ...
    module.exports = DappSmith_1.default;
}
