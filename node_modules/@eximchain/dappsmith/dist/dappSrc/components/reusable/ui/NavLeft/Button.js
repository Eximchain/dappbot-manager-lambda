...
var ButtonSmall_1 = __importDefault(require("./ButtonSmall"));
exports.ButtonSmall = ButtonSmall_1.default;
var ButtonCancel_1 = __importDefault(require("./ButtonCancel"));
exports.ButtonCancel = ButtonCancel_1.default;
var ButtonClose_1 = __importDefault(require("./ButtonClose"));
...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.getClasses = function () {
        ...
        var styles = {};
        //Apply size class
        if (size && exports.SizeMap[size])
            styles[prefix(customClass, exports.SizeMap[size])] = true;
        //Apply classes based on props
        Object.keys(exports.ButtonStyles).filter(function (key) {
            styles[prefix(customClass, key)] = _this.props[key];
        });
        //Overwrite classes with state value
        if (this.state) {
            var _b = this.state, hovered = _b.hovered, pressed = _b.pressed;
            styles[prefix(customClass, exports.ButtonStyles.hovered)] = hovered;
            styles[prefix(customClass, exports.ButtonStyles.pressed)] = pressed;
            styles[prefix(customClass, exports.ButtonStyles.idle)] = !pressed && !hovered;
        }
        this.setState({
