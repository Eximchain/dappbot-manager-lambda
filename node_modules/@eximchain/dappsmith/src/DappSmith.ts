...
if (!shell.which("create-react-app")){
    shell.echo("You need to have create-react-app installed for this utility.  Please run:")
    shell.echo("")
    shell.echo("npm install --global create-react-app")
    shell.echo("")
    shell.exit(1);
}
...
class DappSmith {
    ...
    public generate(){
        ...
        if (shell.exec(`create-react-app ${this.DAPP_NAME} --typescript`).code == 0){
            ...
            console.log("\n\nERROR ON create-react-app, failing out.")
        }
    }
